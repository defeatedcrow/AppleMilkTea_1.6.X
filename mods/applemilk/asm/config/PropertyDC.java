...
import mods.applemilk.asm.config.PropertyDC.Type;

public class PropertyDC
{
    public enum Type
    {
        STRING,
    ...
    public PropertyDC(String name, String value, Type type)
    {
        this(name, value, type, false);
    }

    PropertyDC(String name, String value, Type type, boolean read)
    {
        setName(name);
        this.value = value;
        this.type  = type;
    ...
    public PropertyDC(String name, String[] values, Type type)
    {
        this(name, values, type, false);
    }

    PropertyDC(String name, String[] values, Type type, boolean read)
    {
        setName(name);
        this.type   = type;
        this.values = values;
