...
public class RenderTeaMakerNext implements ISimpleBlockRenderingHandler{
	...
	public void renderInventoryBlock(Block block, int metadata, int modelID,
		...
		this.boxIcon = DCsAppleMilk.teaMakerNext.getIcon(1, 0);
		this.contentsIcon = Block.waterStill.getBlockTextureFromSide(1);
		...
		if (modelID == this.getRenderId())
		{
			...
			renderInvCuboid(renderer, block,  5.0F/16.0F, 4.0F/16.0F, 5.0F/16.0F, 11.0F/16.0F, 10.0F/16.0F, 11.0F/16.0F,  this.contentsIcon);
		}
	...
	public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z,
		...
		if (modelId == this.getRenderId())
		{
			...
			{
				renderer.setOverrideBlockTexture(this.boxIcon);
				block.setBlockBounds(6.0F/16.0F, 13.0F/16.0F, 12.0F/16.0F, 10.0F/16.0F, 14.0F/16.0F, 14.0F/16.0F);
				renderer.setRenderBoundsFromBlock(block);
				renderer.renderStandardBlock(block, x, y, z);
				
				renderer.setOverrideBlockTexture(this.boxIcon);
				block.setBlockBounds(7.0F/16.0F, 13.0F/16.0F, 2.0F/16.0F, 9.0F/16.0F, 14.0F/16.0F, 4.0F/16.0F);
				renderer.setRenderBoundsFromBlock(block);
				renderer.renderStandardBlock(block, x, y, z);
				renderer.setOverrideBlockTexture(this.boxIcon);
				...
				renderer.renderStandardBlock(block, x, y, z);
				renderer.setOverrideBlockTexture(this.boxIcon);
				block.setBlockBounds(7.0F/16.0F, 5.0F/16.0F, 1.0F/16.0F, 9.0F/16.0F, 14.0F/16.0F, 2.0F/16.0F);
				renderer.setRenderBoundsFromBlock(block);
				renderer.renderStandardBlock(block, x, y, z);
			...
			{
				renderer.setOverrideBlockTexture(this.boxIcon);
				block.setBlockBounds(2.0F/16.0F, 13.0F/16.0F, 6.0F/16.0F, 4.0F/16.0F, 14.0F/16.0F, 10.0F/16.0F);
				renderer.setRenderBoundsFromBlock(block);
				renderer.renderStandardBlock(block, x, y, z);
				
				renderer.setOverrideBlockTexture(this.boxIcon);
				block.setBlockBounds(12.0F/16.0F, 13.0F/16.0F, 7.0F/16.0F, 14.0F/16.0F, 14.0F/16.0F, 9.0F/16.0F);
				renderer.setRenderBoundsFromBlock(block);
				renderer.renderStandardBlock(block, x, y, z);
				renderer.setOverrideBlockTexture(this.boxIcon);
				block.setBlockBounds(13.0F/16.0F, 5.0F/16.0F, 7.0F/16.0F, 14.0F/16.0F, 6.0F/16.0F, 9.0F/16.0F);
				renderer.setRenderBoundsFromBlock(block);
				renderer.renderStandardBlock(block, x, y, z);
				renderer.setOverrideBlockTexture(this.boxIcon);
				block.setBlockBounds(14.0F/16.0F, 5.0F/16.0F, 7.0F/16.0F, 15.0F/16.0F, 14.0F/16.0F, 9.0F/16.0F);
				renderer.setRenderBoundsFromBlock(block);
				renderer.renderStandardBlock(block, x, y, z);
			}
			else if (meta == 2)
			...
			{
				renderer.setOverrideBlockTexture(this.boxIcon);
				block.setBlockBounds(12.0F/16.0F, 13.0F/16.0F, 6.0F/16.0F, 14.0F/16.0F, 14.0F/16.0F, 10.0F/16.0F);
				renderer.setRenderBoundsFromBlock(block);
				renderer.renderStandardBlock(block, x, y, z);
				
				renderer.setOverrideBlockTexture(this.boxIcon);
				block.setBlockBounds(2.0F/16.0F, 13.0F/16.0F, 7.0F/16.0F, 4.0F/16.0F, 14.0F/16.0F, 9.0F/16.0F);
				renderer.setRenderBoundsFromBlock(block);
				renderer.renderStandardBlock(block, x, y, z);
				renderer.setOverrideBlockTexture(this.boxIcon);
				...
				renderer.renderStandardBlock(block, x, y, z);
				renderer.setOverrideBlockTexture(this.boxIcon);
				block.setBlockBounds(1.0F/16.0F, 5.0F/16.0F, 7.0F/16.0F, 2.0F/16.0F, 14.0F/16.0F, 9.0F/16.0F);
				renderer.setRenderBoundsFromBlock(block);
				renderer.renderStandardBlock(block, x, y, z);
			}
