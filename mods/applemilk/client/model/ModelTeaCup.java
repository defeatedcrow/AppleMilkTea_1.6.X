...
public class ModelTeaCup extends ModelBase
{
  ...
  public ModelTeaCup()
  {
    ...
    textureHeight = 32;
      ...
      handle1.addBox(-1F, 0F, -5F, 2, 1, 2);
      handle1.setRotationPoint(0F, 17F, 0F);
      handle1.setTextureSize(64, 32);
      handle1.mirror = true;
      setRotation(handle1, 0F, 0F, 0F);
      handle3 = new ModelRenderer(this, 0, 0);
      handle3.addBox(-1F, 0F, -5F, 2, 1, 2);
      handle3.setRotationPoint(0F, 22F, 0F);
      handle3.setTextureSize(64, 32);
      handle3.mirror = true;
      setRotation(handle3, 0F, 0F, 0F);
      handle2 = new ModelRenderer(this, 0, 0);
      handle2.addBox(-1F, 0F, -5F, 2, 6, 1);
      handle2.setRotationPoint(0F, 17F, 0F);
