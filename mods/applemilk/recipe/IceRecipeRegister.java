...
import mods.applemilk.api.recipe.IChargeIce;
import mods.applemilk.api.recipe.IIceRecipe;
import mods.applemilk.api.recipe.IIceRecipeRegister;
...
public class IceRecipeRegister extends RecipeRegisterManager implements IIceRecipeRegister{
	...
	@Override
	public void registerCanLeave(ItemStack input, ItemStack output,
		...
		AMTLogger.debugInfo("Add IceMaker Recipe: input " + input.getDisplayName() + ", output " + output.getDisplayName() + ", container " + container);
	}
