...
import mods.applemilk.api.recipe.ITeaRecipeRegister;
...
public class TeaRecipeRegister implements ITeaRecipeRegister{
	...
	@Override
	public void registerCanMilk(ItemStack input, ItemStack output,
			ItemStack output2, String tex) {
		if (input != null)
		{
	...
	@Override
	public void registerCanMilk(ItemStack input, ItemStack output,
			ItemStack output2, String tex, String milktex) {
		if (input != null)
		{
		...
		AMTLogger.debugInfo("Add TeaMaker Recipe: input " + input.getDisplayName() + ", output " + output.getDisplayName()
				 + ", output_milk " + milkName);
	}
	...
	public class TeaRecipe implements ITeaRecipe {
		...
		public ItemStack getOutputMilk() {
			if (this.outputMilk == null)return null;
			return this.outputMilk.copy();
		}

		@Override
		public String getTex() {
			if (this.Tex == null)return "defeatedcrow:textures/blocks/contents_water.png";
			return this.Tex;
		}
