...
{
    private static final ResourceLocation EggsTexWhite = new ResourceLocation("applemilk:textures/blocks/whitepanel.png");
    private static final ResourceLocation EggsTexBlack = new ResourceLocation("applemilk:textures/blocks/teppann.png");
    ...
    public void setRotation(float par1, float par2, float par3, int par4, TileEggs tile)
    {
        ...
        if ((l & 1) == 0)this.bindTexture(EggsTexWhite);
        else this.bindTexture(EggsTexBlack);
